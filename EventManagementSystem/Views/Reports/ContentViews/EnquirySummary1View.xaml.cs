...
{
    /// <summary>
    /// Interaction logic for EnquirySummary1View.xaml
    /// </summary>
    public partial class EnquirySummary1View : UserControl
    {
        private readonly EnquirySummaryViewModel _viewModel;

        public EnquirySummary1View()
        {
            InitializeComponent();
        ...
        private void Print_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            values[0] = "Enquiry Summary 1 Report";
