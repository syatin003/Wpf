...
{
    public class PaymentReceivedOptionsViewModel : ViewModelBase
    {
        #region Fields
        ...
        public PaymentReceivedOptionsViewModel()
        {
        ...
        {
            Properties.Settings.Default.StartDateInPaymentOption = StartDate;
            Properties.Settings.Default.EndDateInPaymentOption = EndDate;
            Properties.Settings.Default.StartDateGroupValuePayment = StartDateGroupValue;
            Properties.Settings.Default.EndDateGroupValuePayment = EndDateGroupValue;
            Properties.Settings.Default.DaysForwardPayment = DaysForward;
            Properties.Settings.Default.DaysBackwardPayment = DaysBackward;
            Properties.Settings.Default.IsPaymentReceivedDateChecked = IsReceivedDateChecked;
        ...
        {
            StartDate = Properties.Settings.Default.StartDateInPaymentOption;
            EndDate = Properties.Settings.Default.EndDateInPaymentOption;
            ...
            IsReceivedDateChecked = Properties.Settings.Default.IsPaymentReceivedDateChecked;
        }
